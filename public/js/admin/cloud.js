// ================================================================
// admin/cloud.js - Cloud storage, Upstash
// ================================================================
...
function updateStorageBadges(info) {
  ...
  if (info.upstashInvalidUrl) {
    ...
    if(headerBadge) { headerBadge.className = 'ping-badge ok'; headerBadge.textContent = '🟢 Aktif'; }
    if(cardBadge) { cardBadge.className = 'ping-badge ok'; cardBadge.textContent = '🟢 Aktif'; }
